...
public class AlarmReceiver extends WakefulBroadcastReceiver {
     ...
     * @param context
     */
    public void setAlarm(Context context,int day,int month,int year,int hour,int minute) {
        Log.i("EFAIR","in set alarm"+minute);
        alarmMgr = (AlarmManager)context.getSystemService(Context.ALARM_SERVICE);
        Intent intent = new Intent(context, MedFragment.class);
        //put the massage
        ...
        // device is rebooted.
        ComponentName receiver = new ComponentName(context, MedFragment.class);
