...
public class CustomExpandableView extends RelativeLayout {
    ...
    private void init() {
        inflate(this.getContext(), R.layout.expandable_view, this);
        this.outsideContentLayoutList = new ArrayList();
        this.textView = (TextView)this.findViewById(R.id.expandable_view_title);
        this.clickableLayout = (RelativeLayout)this.findViewById(R.id.expandable_view_clickable_content);
        this.contentLayout = (LinearLayout)this.findViewById(R.id.expandable_view_content_layout);
        this.leftIcon = (ImageView)this.findViewById(R.id.expandable_view_image);
        this.rightIcon = (ImageView)this.findViewById(R.id.expandable_view_right_icon);
